...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option value=<?php if($etapaF1 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option value=<?php if($etapaF1 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option value=<?php if($etapaF1 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG1 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG1 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  ...
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF2 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF2 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF2 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda"2>
                                                        <option <?php if($etapaG2 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG2 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>                    
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF3 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF3 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF3 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG3 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG3 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF4 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF4 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF4 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG4 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG4 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF5 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF5 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF5 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG5 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG5 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF6 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF6 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF6 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG6 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG6 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF7 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF7 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF7 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG7 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG7 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF8 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF8 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF8 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG8 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG8 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF9 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF9 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF9 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG9 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG9 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF10 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF10 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF10 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG10 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG10 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF11 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF11 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF11 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG11 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG11 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF12 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF12 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF12 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG12 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG12 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF13 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF13 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF13 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG13 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG13 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF14 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF14 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF14 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG14 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG14 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF15 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF15 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF15 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG15 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG15 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF16 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF16 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF16 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG16 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG16 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF17 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF17 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF17 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG17 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG17 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF18 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF18 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF18 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG18 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG18 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF19 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF19 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF19 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG19 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG19 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-7zrl text-center text-center"><select id="tipoAjuda" >
                                                         <option <?php if($etapaF20 == '0') {echo ("selected");}?>>Paciente</option>
                                                         <option <?php if($etapaF20 == '1') {echo ("selected");}?>>Terapeuta</option>  
                                                         <option <?php if($etapaF20 == '2') {echo ("selected");}?>>Ajuda Espec.</option>  
                                                </select>
    </td>
    <td class="tg-7zrl text-center text-center"><select id="configAjuda" >
                                                        <option <?php if($etapaG20 == '0') {echo ("selected");}?>>Paciente</option>
                                                        <option <?php if($etapaG20 == '1') {echo ("selected");}?>>Terapeuta</option>                                                                   
                                                </select>
    </td>
  </tr>
  <tr>
...
<div class="container mt-4 mb-4">
  ...
  <a class="button" href=<?php echo ("../userterapeuta/resultadoBack.php?idt='$idterapeuta'&idpc='$idpaciente'&idav='$idavaliacao'&idtaju='AAA'&idconfAju='BBB' "); ?> class="btn btn-primary">Salvar</a>
