                ...
                <table id="mytable" class="table table-bordred table-striped">
                    ...
                    <?php 
                        while($dado = mysqli_fetch_array($query)) {
                            ...
                            echo "<td>".'<a href="resultadoA.php?id='.$dado['pacienteid'].'&email='.$dado['EmailPaciente'].' " class="btn btn-primary btn-md" role="button" aria-pressed="true">Primary link</a>'."</td>";                            
                            echo"</tr>";
