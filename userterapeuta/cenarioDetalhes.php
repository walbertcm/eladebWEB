...
$sql = "SELECT cp.`idcenario`, cp.`idpergunta`, p.pergunta,p.imagem, c.nomecenario as nomecenario FROM `cenarioPerguntas` as cp RIGHT JOIN perguntas as p ON cp.`idpergunta` = p.idperguntas RIGHT JOIN cenario as c ON cp.`idcenario` = c.idcenario WHERE cp.`idcenario` = $idCenario";
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table id="mytable" class="table table-bordred table-striped">
                  <h2>Questões do cenário</h2>  
                  <thead>
                    <tr>
                      <th scope="col" class="text-left">Nome do cenário</th>
