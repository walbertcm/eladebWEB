...
$sql = "SELECT * FROM `terapeuta` ORDER BY `nome` ";
        ...
        <div class="col-md-12">
            ...
            <h2>Lista de pacientes</h2>  
                <table id="mytable" class="table table-bordred table-striped">
                    <thead>
                    <th scope="col" class="text-center">Nome do terapeuta</th>
                    <th scope="col" class="text-center">Email do terapeuta</th>
                    </thead>
                    <!-- Corpo da Tabela-->
